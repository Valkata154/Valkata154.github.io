...
$("#subject__button--1").click(function() {
    ...
    // Year Two
        ...
        document.getElementById('popup__details').innerHTML = "<span>In this module I gained</span> knowledge about fundamental areas of operating systems that underpin much of the technology of the internet age. Emphasising both on design issues and fundamental principles in contemporary systems and getting a solid understanding of the key structures and mechanisms of operating systems by focusing on Unix based Operating Systems and Windows. I examined the software components that run current devices, and how they support user operations. Through a popular Linux distribution I gained practical experience in Unix and Unix scripting, which is an important technology that, running on servers, underpins much of the modern computational infrastructures. Additionally, I got practical experience on Windows command line, named Powershell understanding the similarities and differences between the two dominating operating systems.<br><br><span>Learning outcomes</span> include being able to: identify fundamental principles, security and design issues in modern operating systems, describe in detail how the key components of an operating system work and interact, demonstrate extended knowledge of UNIX and Windows through Linux and Powershell command lines usage, demonstrate the ability to develop robust Unix shell scripts through Linux. <br><br><span>Assessment</span> was in the form of one Linux group coursework (<span>100%</span>) having 40% of the final module mark and one class test (<span>MARK</span>) having 60% of the final module mark.";
    // Year Three
...
$("#subject__button--3").click(function() {
    ...
    if(document.querySelector("#education-uni__btn--1").classList.contains("active")){
        ...
        document.getElementById('popup__details').innerHTML = "<span>In this module I learned</span> to design and write computer programs in Java, with an emphasis on object-oriented programming using Eclipse as an Integrated Development Environment. I learned Java basics, how to write OOP programs and how to make UML diagrams.<br><br><span>Learning outcomes</span> include being able to: design algorithms to solve simple problems, implement simple algorithms in Java, identify the key concepts of object-oriented programming, implement simple object-oriented designs in Java, identify key computing structures and concepts.<br><br><span> Assessment</span> was in the form of one class test (<span>96%</span>) having 25% of the final module mark, one group presentation (<span>100%</span>) having 15% of the final mark and one coursework (<span>MARK</span>) having 60% of the final module mark.";
    // Year Two
    }else if(document.querySelector("#education-uni__btn--2").classList.contains("active")){
        document.getElementById('popup__subject').innerHTML = "Object Oriented Software Development";
        document.getElementById('popup__details').innerHTML = "<span>In this module I gained</span> knowledge about: problem solving approaches and algorithmic expression, object oriented software development in C#, introduction to data structures using C# collections, designing and developing user interfaces using C# controls, application design techniques, practical testing techniques. <br><br><span>Learning outcomes</span> include being able to: implement and debug C# applications using an integrated development environment, design, develop and test object-oriented C# applications, develop C# applications with graphical user interfaces, file handling and data structures, design test cases and generate test specifications and reports.<br><br><span>Assessment</span> was in the form of one coursework (<span>95%</span>) having 20% of the final module mark and another coursework (<span>MARK</span>) having 80% of the final module mark.";
    // Year Three
    }else if(document.querySelector("#education-uni__btn--3").classList.contains("active")){
        document.getElementById('popup__subject').innerHTML = "No Information At The Moment";
        document.getElementById('popup__details').innerHTML = "No Information Available";
